...
preprocessed_documents_new=[]
for x in preprocessed_documents:
    for y in x:
        preprocessed_documents_new.append(y)
print(preprocessed_documents_new)
...
for i in preprocessed_documents_new:
